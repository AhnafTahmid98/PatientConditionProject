...
# Refined human temperature range and reduced offset
HUMAN_TEMP_RANGE = (35.0, 39.0)  # Slightly expanded range
HUMAN_TEMP_THRESHOLD_OFFSET = 0.5  # Lower offset for higher sensitivity
